...
tha's private, but what I will say is I had to dedicate most of my personal time to something irl, outside of my job at the time. It was a bit of a rough time.
...
I don't know, but if I did I promise I would have already explained it, and posted everything needed to completely restore it. Unfortunately, it still has the same slow exit bug. 
...
#### TL;DR
This project died around the time my father passed, and in my depression, I neglected to reply to those who reached out. I got a full-time job at a company my dada used to support. I have lots to work on irl, but I am back now, here and on reddit. I may post some new repo's soon, but they won't be related to 10SM. 
